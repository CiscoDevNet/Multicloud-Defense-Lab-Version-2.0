...
locals {
  vpc_cidr1    = "10.1.${var.pod_number}.0/24"
  vpc_cidr2    = "10.1.${var.pod_number + 100}.0/24"
  subnet_cidr1 = "10.1.${var.pod_number}.0/26"
  subnet_cidr2 = "10.1.${var.pod_number + 100}.0/26"
  app1_nic     = ["10.1.${var.pod_number}.10"]
  app2_nic     = ["10.1.${var.pod_number + 100}.10"]
}
...
resource "aws_vpc" "app_vpc" {
  ...
  tags = {
    Name = "pod${var.pod_number}-app${count.index + 1}-vpc-aws"
  }
}
...
resource "aws_subnet" "app_subnet" {
  ...
  tags = {
    Name = "pod${var.pod_number}-app${count.index + 1}-subnet-aws"
  }
}

resource "aws_subnet" "mgmt_subnet" {
  vpc_id            = aws_vpc.app_vpc[0].id
  cidr_block        = "10.1.${var.pod_number}.64/26"
  availability_zone = "us-east-1a"
  tags = {
