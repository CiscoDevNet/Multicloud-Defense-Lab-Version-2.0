...
locals {
  subnet_cidr1 = "10.3.${var.pod_number}.0/26"
  subnet_cidr2 = "10.3.${var.pod_number + 100}.0/26"
  app1_nic     = "10.3.${var.pod_number}.10"
  app2_nic     = "10.3.${var.pod_number + 100}.10"
}
...
resource "google_compute_network" "network" {
  count                   = 2
  name                    = "pod${var.pod_number}-app${count.index + 1}-vpc-gcp"
  routing_mode            = "GLOBAL"
  project                 = var.project_id
...
resource "google_compute_subnetwork" "subnets" {
  count         = 2
  name          = "pod${var.pod_number}-app${count.index + 1}-subnet-gcp"
